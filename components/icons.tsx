...
export const WarriorIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" {...props}>
    <path fillRule="evenodd" d="M10 2.5c-1.34 0-2.5.4-3.5 1.05V10H6v5H5v-5H3.5a.5.5 0 01-.5-.5v-4a.5.5 0 01.5-.5h.211c.42-.907 1.05-1.725 1.838-2.434C5.73 2.84 6.35 2.5 7 2.5h6c.65 0 1.27.34 1.952.816.787.709 1.417 1.527 1.838 2.434h.21a.5.5 0 01.5.5v4a.5.5 0 01-.5.5H15v5h-1v-5h-.5V3.55C12.5.4 11.34 0 10 0a6.5 6.5 0 00-4.596 1.904A6.53 6.53 0 003.5 8v1.5H10v-5h-.5V3.55c-.25-.032-.5-.05-.75-.05h-1.5c-.25 0-.5.018-.75.05V10H6v5h8v-5h-.5V8a6.53 6.53 0 00-1.904-4.596A6.5 6.5 0 0010 2zM12 11.5a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0z" clipRule="evenodd" />
    <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1.07 15.42L5.5 12.5l1.07-1.07 4.43 4.43-1.07 1.06zM15.57 9.53l-5.5 5.5-1.07-1.06 5.5-5.5 1.07 1.06zM12 6.5a1.5 1.5 0 100-3 1.5 1.5 0 000 3z" />
  </svg>
);
export const MageIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" {...props}>
    <path d="M10 2a.75.75 0 01.75.75v3.44l1.72-1.72a.75.75 0 111.06 1.06l-1.72 1.72h3.44a.75.75 0 010 1.5h-3.44l1.72 1.72a.75.75 0 11-1.06 1.06l-1.72-1.72v3.44a.75.75 0 01-1.5 0v-3.44l-1.72 1.72a.75.75 0 11-1.06-1.06l1.72-1.72H3.53a.75.75 0 010-1.5h3.44L5.25 6.53a.75.75 0 011.06-1.06L8 7.19V3.75A.75.75 0 018.75 3h.5A.75.75 0 0110 3.75v-.75A.75.75 0 0110 2z"/>
  </svg>
);
export const RogueIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" {...props}>
    <path fillRule="evenodd" d="M10 2a.75.75 0 01.75.75v1.5a.75.75 0 01-1.5 0v-1.5A.75.75 0 0110 2zM5.22 5.22a.75.75 0 011.06 0l1.25 1.25a.75.75 0 01-1.06 1.06L5.22 6.28a.75.75 0 010-1.06zM13.72 5.22a.75.75 0 010 1.06l-1.25 1.25a.75.75 0 01-1.06-1.06l1.25-1.25a.75.75 0 011.06 0zM17 10a.75.75 0 01-.75.75h-1.5a.75.75 0 010-1.5h1.5a.75.75 0 01.75.75zM4.75 10.75a.75.75 0 010-1.5h-1.5a.75.75 0 010 1.5h1.5zM8 13a2 2 0 100-4 2 2 0 000 4zm4-2a2 2 0 11-4 0 2 2 0 014 0zM6.28 14.78a.75.75 0 010-1.06l1.25-1.25a.75.75 0 111.06 1.06L7.34 14.78a.75.75 0 01-1.06 0zm7.44 0a.75.75 0 01-1.06 0l-1.25-1.25a.75.75 0 011.06-1.06l1.25 1.25a.75.75 0 010 1.06zM10 18a.75.75 0 01-.75-.75v-1.5a.75.75 0 011.5 0v1.5A.75.75 0 0110 18z" clipRule="evenodd"/>
  </svg>
);
export const GemIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" {...props}>
    <path d="M10 1.52l-6.29 6.29a1 1 0 000 1.41L10 18.48l6.29-6.29a1 1 0 000-1.41L10 1.52zm-3.58 7L10 5.09l3.58 3.43L10 11.91 6.42 8.52z"/>
  </svg>
);
